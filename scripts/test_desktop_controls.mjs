...
check('zoom does not overlap the Weights button', !overlaps(boxes.zoomIn, boxes.weights));
...
check('Help stays removed while Weights is restored as a floating map control',
