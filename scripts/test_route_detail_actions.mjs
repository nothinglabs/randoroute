...
const previewContext = vm.createContext({
  ...
  BIKE_NETWORK_COLOR: '#b7c900', PASS_COLOR: '#168ad1', CAUTION_COLOR: '#a65300', FAIL_COLOR: '#b2182b',
  isBikeNetwork: (seg) => !!((seg.flags || 0) & 8) || (seg.facility || 0) >= 2,
  isDesignated: () => false,
...
]).join('|')`, previewContext), '#b7c900|#b2182b|#a65300|#168ad1',
