...
(function (root) {
  ...
  // Baseline measured from the largest released graph (Washington, BGRD,
  // 2026-08-27 rebuild). This is an input-byte ceiling, not a claim about
  ...
  const MAX_DETAILED_GRAPH_INPUT_BYTES = 152141368;
