...
of a paved state highway is marked as a mountain-bike trail (`maps/nevada/
ROUTING-AUDIT.md`, N1). Finding that took an unconstrained BFS, an edge-flag
dump and an OSM relation lookup.
