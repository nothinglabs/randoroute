...
|---|---|---|
| **WSDOT BLTS** (`BikePedLTS` geodatabase) | Level of Traffic Stress 1–4, shoulder width, speed limit, lane count, limited-access and prohibition flags, for **state routes only** | **in use** — `maps/washington/blts.geojson`, built by `scripts/build_blts.py` |
