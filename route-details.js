...
function routeSummaryStats(segs, minShoulderFt = 4) {
  ...
  let bikeNetworkM = 0, roadM = 0, roadSpeedM = 0, unpavedM = 0, dismountM = 0;
  ...
  return {
    levels, bikeNetworkM, unpavedM, dismountM,
